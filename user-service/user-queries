...
CREATE TABLE `user` (
  ...
  `us_password` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`us_id`),
...
INSERT INTO `user` VALUES (1,'usr','$2a$10$R/lZJuT9skteNmAku9Y7aeutxbOKstD5xE5bHOf74M2PHZipyt3yK'),(2,'admin','$2a$10$R/lZJuT9skteNmAku9Y7aeutxbOKstD5xE5bHOf74M2PHZipyt3yK');
...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `ur_us_fk` FOREIGN KEY (`ur_us_id`) REFERENCES `user` (`us_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
